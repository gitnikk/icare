...
@Component({
  selector: 'app-doctor-caselist',
  templateUrl: './doctor-caselist.component.html',
  styleUrls: ['./doctor-caselist.component.css']

})
export class DoctorCaselistComponent implements OnInit {
