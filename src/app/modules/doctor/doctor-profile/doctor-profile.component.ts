...
export class DoctorProfileComponent implements OnInit {
  ...
  ngOnInit() {
    this.doctorUserId = this.sessionService.getProfileId();
  ...
  getProfileImg(){
    ...
    this.DoctorService.getSignedUrl(formData).subscribe(
      (data: any) => {
  ...
  onSubmit(){
    ...
    if(this.myProfileForm.valid) {
      ...
      this.DoctorService.updateMyProfile(this.doctorUserId, formData).subscribe(
        (data: any) => {
